        ...
        <section className="flex flex-col md:flex-row h-screen items-center">
            ...
            >
                <div className="w-full h-100">
                    <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Connexion</h1>
                ...
                <p className="mt-8">
                    Besoin d'un compte ?
                    <a href="/auth/register" className="text-blue-500 hover:text-blue-700 font-semibold"> Créer un compte</a>
                </p>
            </div>
        </div>
        </section>
