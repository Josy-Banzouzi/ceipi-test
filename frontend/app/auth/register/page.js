        ...
        <section className="flex flex-col md:flex-row h-screen items-center">
            ...
            >
                <div className="w-full h-100">
                    <h1 className="text-xl md:text-2xl font-bold leading-tight mt-12">Creer votre compte</h1>
                ...
                <p className="mt-8 md:text-center">
                    ...
                    <a href="/auth/login" className="text-blue-500 hover:text-blue-700 font-semibold"> Connexion</a>
                </p>
            </div>
        </div>
</section>
